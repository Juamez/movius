//  const trailerSection = document.querySelector('.section__trailers')
//  const genresSection = document.querySelector('.section__genre')
//  const trendingSection = document.querySelector('.trending__container')
//  const genericSection = document.querySelector('.section__generic')
...
// Sections
 ...
 export const likedMoviesListArticle = document.querySelector('.liked-movieList');
